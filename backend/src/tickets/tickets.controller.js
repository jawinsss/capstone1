...
var TicketsController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('tickets'), (0, common_1.Controller)('tickets')];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _instanceExtraInitializers = [];
    var _list_decorators;
    var _listOpen_decorators;
    ...
    var TicketsController = _classThis = /** @class */ (function () {
        ...
        TicketsController_1.prototype.list = function (type) {
            return this.ticketsService.list(type);
        };
        TicketsController_1.prototype.listOpen = function () {
            return this.ticketsService.listOpen();
        };
        TicketsController_1.prototype.updateStatus = function (id, status) {
    ...
    (function () {
        ...
        _listOpen_decorators = [(0, common_1.Get)('open'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard), (0, roles_decorator_1.Roles)('ADMIN'), (0, swagger_1.ApiBearerAuth)()];
        ...
        __esDecorate(_classThis, null, _listOpen_decorators, { kind: "method", name: "listOpen", static: false, private: false, access: { has: function (obj) { return "listOpen" in obj; }, get: function (obj) { return obj.listOpen; } }, metadata: _metadata }, null, _instanceExtraInitializers);
