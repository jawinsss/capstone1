...
var PaymentsService = function () {
    ...
    var PaymentsService = _classThis = /** @class */ (function () {
        ...
        PaymentsService_1.prototype.listPending = function () {
        ...
        PaymentsService_1.prototype.confirm = function (id) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.prisma.payment.update({ where: { id: id }, data: { status: 'CONFIRMED' } })];
                        case 2:
                            updated = _a.sent();
