...
var UpdateUserDto = function () {
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _fullName_decorators = [(0, swagger_1.ApiProperty)({ description: 'User full name', required: false }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            _email_decorators = [(0, swagger_1.ApiProperty)({ description: 'User email address', required: false }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsEmail)()];
            ...
            _role_decorators = [(0, swagger_1.ApiProperty)({ description: 'User role', required: false }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsIn)(['USER', 'ADMIN'])];
